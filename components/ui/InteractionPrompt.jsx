      ...
      {showPrompt && (
        ...
        >
          {isNearJukebox && !station ? (
            <div className="rounded-xl border-3 border-slate-950 bg-amber-300 px-3 py-2 sm:px-5 sm:py-2.5 text-center shadow-[5px_5px_0px_0px_#090d16]">
              ...
              >
                <kbd className="hidden sm:inline-block rounded border-2 border-slate-950 bg-white px-2 py-0.5 text-slate-950 shadow-[2px_2px_0px_0px_#090d16]">
                  J
                </kbd>
                <span className="sm:hidden">CLICK TO USE JUKEBOX ↗</span>
                <span className="hidden sm:inline">USE JUKEBOX (MUSIC DISCS) ↗</span>
              </button>
            </div>
          ) : station ? (
            <div className="rounded-xl border-3 border-slate-950 bg-emerald-200 px-3 py-2 sm:px-5 sm:py-2.5 text-center shadow-[5px_5px_0px_0px_#090d16]">
              ...
              >
                ...
                <span className="sm:hidden">CLICK TO OPEN RELIC CHEST ↗</span>
                <span className="hidden sm:inline">OPEN RELIC CHEST ↗</span>
              </button>
            </div>
          ) : null}
        </motion.div>
